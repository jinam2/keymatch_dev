...
var gcCalFrame="#499A6B";	//#45453E 테이블 일자 bgcolor : the background color of the inner table, showing as a frame.
var gsInnerTable="border=0 cellpadding=2 cellspacing=0";	// HTML tag properties of the inner <table> tag, which holds all the calendar cells.
var gsOuterTable=NN4?"border=0 cellpadding=3 cellspacing=0":"border=0 cellpadding=1 cellspacing=1";	// HTML tag properties of the outmost container <table> tag, which holds the top, middle and bottom sections.
...
var gcSatBG="#CEE7FF";	// #99ccff 토요일 칸 배경색 : Saturday background color
var gcSun="red";	// Sunday font color
var gcSunBG="#FFE1E1";	//#FEB2B2 일요일 칸배경색 : Sunday background color
