    ...
    private $iLED_X = 4, $iLED_Y=7,
        ...
        */
        ...
        $iLEDSpec = array(
            ...
            '|' => array(4,4,4,4,4,4,4), //vertical line, used for simulate rus '竅'
            ...
            ' ' => array(0,0,0,0,0,0,0),
            '\xE2\xA2' => array(0,0,6,6,0,0,0), //149
            '째' => array(14,10,14,0,0,0,0), //176
            '\xE2\xA0' => array(4,4,14,4,4,4,4), //134
            '\xE2\xA1' => array(4,4,14,4,14,4,4), //135
            '짹' => array(0,4,14,4,0,14,0), //177
            '\xE2\xB0' => array(0,4,2,15,2,4,0), //137 show right arrow
            '\xE2꽓' => array(0,2,4,15,4,2,0), //156 show left arrow
            '\xD0\x8E' => array(0,0,8,8,0,0,0), //159 show small hi-stick - that need for simulate rus '圭'
            "\t" => array(8,8,8,0,0,0,0), //show hi-stick - that need for simulate rus '叫'
            "\r" => array(8,8,8,8,8,8,8), //vertical line - that need for simulate 'M', 'W' and rus '\xD0\x9C','珪' ,'硅'
            "\n" => array(15,15,15,15,15,15,15), //fill up - that need for simulate rus '\xD0\x96'
            "\xD2\x90" => array(10,5,10,5,10,5,10), //chess
            "쨉" => array(15,0,15,0,15,0,15), //4 horizontal lines
            // latin
            ...
            // russian utf-8
            '\xD0\x90' => array(6,9,9,15,9,9,9),
            '\xD0\x91' => array(14,8,8,14,9,9,14),
            '\xD0\x92' => array(14,9,9,14,9,9,14),
            '\xD0\x93' => array(15,8,8,8,8,8,8),
            '\xD0\x94' => array(14,9,9,9,9,9,14),
            '\xD0\x95' => array(15,8,8,14,8,8,15),
            '\xD0\x81' => array(6,15,8,14,8,8,15),
            //\xD0\x96 is combine: >\n<
            '\xD0\x97' => array(6,9,1,2,1,9,6),
            '\xD0\x98' => array(9,9,9,11,13,9,9),
            '\xD0\x99' => array(13,9,9,11,13,9,9),
            '\xD0\x9A' => array(9,10,12,10,9,9,9),
            '\xD0\x9B' => array(7,9,9,9,9,9,9),
            '\xD0\x9C' => array(8,13,10,8,8,8,8),// need to add \r
            '\xD0\x9D' => array(9,9,9,15,9,9,9),
            '\xD0\x9E' => array(6,9,9,9,9,9,6),
            '\xD0\x9F' => array(15,9,9,9,9,9,9),
            '\xD0\xA0' => array(14,9,9,14,8,8,8),
            '鬼' => array(6,9,8,8,8,9,6),
            '龜' => array(14,4,4,4,4,4,4),
            '叫' => array(9,9,9,7,1,9,6),
            '圭' => array(2,7,10,10,7,2,2),// need to add \xD0\x8E
            '奎' => array(9,9,6,6,6,9,9),
            '揆' => array(10,10,10,10,10,15,1),
            '槻' => array(9,9,9,7,1,1,1),
            '珪' => array(10,10,10,10,10,10,15),// \r
            '硅' => array(10,10,10,10,10,15,0),// need to add \r
            '窺' => array(12,4,4,6,5,5,6),
            '竅' => array(8,8,8,14,9,9,14),// need to add |
            '糾' => array(8,8,8,14,9,9,14),
            '葵' => array(6,9,1,7,1,9,6),
            '規' => array(2,2,2,3,2,2,2),// need to add O
            '赳' => array(7,9,9,7,3,5,9)
            ),
