...
<!-- 우측 -->
<List url="$sub_url/admin/type_setting.php" target="_parent" boxtext="채용정보 검색하기" boxtexttwo="대표관련정보 직종(카테고리)설정으로 이동합니다." simages="img/shot/053s.png" bimages="img/shot/053.png" bimgwidth="760" bimgheight="101" Xaxis="170" Yaxis="235" gapspace="0" movemode="TR" keyway="top"/>

<List url="$sub_url/admin/type_setting.php" target="_parent" boxtext="채용정보 카테고리" boxtexttwo="직종(카테고리)설정으로 이동합니다." simages="img/shot/054s.png" bimages="img/shot/054.png" bimgwidth="760" bimgheight="110" Xaxis="170" Yaxis="355" gapspace="0" movemode="TR" keyway="top"/>

<List url="$sub_url/admin/guin.php?a=guin&mode=list" target="_parent" boxtext="우대등록 채용정보" boxtexttwo="채용정보관리로 이동합니다." simages="img/shot/055s.png" bimages="img/shot/055.png" bimgwidth="760" bimgheight="283" Xaxis="170" Yaxis="450" gapspace="0" movemode="TR" keyway="top"/>

<List url="$sub_url/admin/happy_config_view.php?number=24" target="_parent" boxtext="구글광고" boxtexttwo="외부광고관리로 이동합니다." simages="img/shot/056s.png" bimages="img/shot/056.png" bimgwidth="760" bimgheight="90" Xaxis="170" Yaxis="685" gapspace="0" movemode="TR" keyway="top"/>

<List url="$sub_url/admin/guin.php?a=guin&mode=list" target="_parent" boxtext="프리미엄 채용정보" boxtexttwo="채용정보관리로 이동합니다." simages="img/shot/057s.png" bimages="img/shot/057.png" bimgwidth="760" bimgheight="180" Xaxis="170" Yaxis="760" gapspace="0" movemode="TR" keyway="top"/>

<List url="$sub_url/admin/guin.php?a=guin&mode=list" target="_parent" boxtext="급구 채용정보" boxtexttwo="채용정보관리로 이동합니다." simages="img/shot/058s.png" bimages="img/shot/058.png" bimgwidth="760" bimgheight="304" Xaxis="170" Yaxis="910" gapspace="0" movemode="TR" keyway="top"/>

<List url="$sub_url/admin/guin.php?a=guin&mode=list" target="_parent" boxtext="추천/스페셜 채용정보" boxtexttwo="채용정보관리로 이동합니다." simages="img/shot/059s.png" bimages="img/shot/059.png" bimgwidth="760" bimgheight="234" Xaxis="170" Yaxis="1160" gapspace="0" movemode="TR" keyway="top"/>

<List url="$sub_url/admin/guin.php?a=guin&mode=list" target="_parent" boxtext="채용정보리스트" boxtexttwo="채용정보관리로 이동합니다." simages="img/shot/060s.png" bimages="img/shot/060.png" bimgwidth="760" bimgheight="235" Xaxis="170" Yaxis="1350" gapspace="0" movemode="TR" keyway="top"/>

<List url="$sub_url/admin/type_setting.php" target="_parent" boxtext="검색정보선택" boxtexttwo="대표관련정보 직종(카테고리)설정으로 이동합니다" simages="img/shot/061s.png" bimages="img/shot/061.png" bimgwidth="760" bimgheight="24" Xaxis="170" Yaxis="1575" gapspace="0" movemode="TR" keyway="top"/>
...
<!-- 하단 -->
<List url="" target="_parent" boxtext="회사소개" boxtexttwo="html_file/site_compnay.html 파일" simages="img/shot/036s.png" bimages="img/shot/036.png" bimgwidth="139" bimgheight="35" Xaxis="20" Yaxis="1606" gapspace="0" movemode="TC" keyway="top"/>

<List url="$sub_url/bbs_regist.php?id=&b_category=&tb=board_bannerreg" target="_parent" boxtext="광고문의" boxtexttwo="게시판관련 부분입니다." simages="img/shot/037s.png" bimages="img/shot/037.png" bimgwidth="120" bimgheight="35" Xaxis="130" Yaxis="1606" gapspace="0" movemode="TC" keyway="top"/>

<List url="" target="_parent" boxtext="개인정보보호정책" boxtexttwo="html_file/site_rule.html 파일" simages="img/shot/038s.png" bimages="img/shot/038.png" bimgwidth="140" bimgheight="35" Xaxis="230" Yaxis="1606" gapspace="0" movemode="TC" keyway="top"/>

<List url="" target="_parent" boxtext="이용약관" boxtexttwo="html_file/site_rule2.html 파일" simages="img/shot/039s.png" bimages="img/shot/039.png" bimgwidth="130" bimgheight="35" Xaxis="340" Yaxis="1606" gapspace="0" movemode="TC" keyway="top"/>

<List url="$sub_url/admin/bbs.php?mode=list" target="_parent" boxtext="공지사항" boxtexttwo="게시판관리로 이동합니다." simages="img/shot/040s.png" bimages="img/shot/040.png" bimgwidth="125" bimgheight="35" Xaxis="445" Yaxis="1606" gapspace="0" movemode="TC" keyway="top"/>

<List url="$sub_url/admin/bbs.php?mode=list" target="_parent" boxtext="커뮤니티" boxtexttwo="관련정보 게시판관리로 이동합니다." simages="img/shot/041s.png" bimages="img/shot/041.png" bimgwidth="125" bimgheight="35" Xaxis="550" Yaxis="1606" gapspace="0" movemode="TC" keyway="top"/>

<List url="$sub_url/admin/bbs.php?mode=list" target="_parent" boxtext="고객지원게시판" boxtexttwo="게시판관리로 이동합니다." simages="img/shot/042s.png" bimages="img/shot/042.png" bimgwidth="171" bimgheight="35" Xaxis="650" Yaxis="1606" gapspace="0" movemode="TC" keyway="top"/>

<List url="$sub_url/admin/main_logo_admin.php" target="_parent" boxtext="하단정보" boxtexttwo="관련정보 로고관리로 이동합니다." simages="img/shot/043s.png" bimages="img/shot/043.png" bimgwidth="950" bimgheight="94" Xaxis="20" Yaxis="1642" gapspace="0" movemode="BL" keyway="top"/>
...
-->
<speed keycolor="FF7202" keycolortwo="EEEEEE" bgimg="img/shot/shot02_800.png"/>
</xmlstart>
END;
