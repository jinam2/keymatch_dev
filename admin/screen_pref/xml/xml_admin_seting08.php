...
<!-- 우측 -->
<List url="$sub_url/admin/admin.php?area=mod" target="_parent" boxtext="채용정보 검색하기(채용종류)" boxtexttwo="채용/이력서 등록옵션 설정으로 이동합니다." simages="img/shot/096s.png" bimages="img/shot/096.png" bimgwidth="246" bimgheight="59" Xaxis="170" Yaxis="235" gapspace="0" movemode="TL" keyway="top"/>

<List url="$sub_url/admin/type_setting.php" target="_parent" boxtext="채용정보 검색하기(직종선택)" boxtexttwo="직종설정으로 이동합니다." simages="img/shot/097s.png" bimages="img/shot/097.png" bimgwidth="514" bimgheight="59" Xaxis="370" Yaxis="235" gapspace="0" movemode="TR" keyway="top"/>

<List url="$sub_url/admin/admin.php?area=mod" target="_parent" boxtext="채용정보 검색하기(경력선택)" boxtexttwo="채용/이력서 등록옵션 설정으로 이동합니다." simages="img/shot/098s.png" bimages="img/shot/098.png" bimgwidth="246" bimgheight="32" Xaxis="170" Yaxis="285" gapspace="0" movemode="TL" keyway="top"/>

<List url="$sub_url/admin/area_setting.php" target="_parent" boxtext="채용정보 검색하기(지역선택)" boxtexttwo="지역설정으로 이동합니다." simages="img/shot/099s.png" bimages="img/shot/099.png" bimgwidth="514" bimgheight="32" Xaxis="370" Yaxis="285" gapspace="0" movemode="TR" keyway="top"/>

<List url="$sub_url/admin/admin.php?area=mod" target="_parent" boxtext="채용정보 카테고리" boxtexttwo="직종(카테고리)선택으로 이동합니다." simages="img/shot/100s.png" bimages="img/shot/100.png" bimgwidth="760" bimgheight="111" Xaxis="170" Yaxis="360" gapspace="0" movemode="TL" keyway="top"/>

<List url="$sub_url/admin/guin.php?a=guin&mode=list" target="_parent" boxtext="채용정보" boxtexttwo="채용정보관리로 이동합니다." simages="img/shot/101s.png" bimages="img/shot/101.png" bimgwidth="760" bimgheight="138" Xaxis="170" Yaxis="450" gapspace="0" movemode="TL" keyway="top"/>

<List url="$sub_url/admin/happy_icon_admin.php" target="_parent" boxtext="플래시지도정보표시" boxtexttwo="색상변경관련 이미지관리/색상변경으로 이동합니다." simages="img/shot/102s.png" bimages="img/shot/102.png" bimgwidth="553" bimgheight="433" Xaxis="170" Yaxis="570" gapspace="0" movemode="TL" keyway="top"/>

<List url="$sub_url/admin/guin.php?a=guin&mode=list" target="_parent" boxtext="추천캐스팅정보" boxtexttwo="채용정보관리로 이동합니다." simages="img/shot/103s.png" bimages="img/shot/103.png" bimgwidth="207" bimgheight="433" Xaxis="615" Yaxis="570" gapspace="0" movemode="TR" keyway="top"/>

<List url="$sub_url/admin/guin.php?a=guin&mode=list" target="_parent" boxtext="채용정보 리시트" boxtexttwo="채용정보관리로 이동합니다." simages="img/shot/104s.png" bimages="img/shot/104.png" bimgwidth="760" bimgheight="694" Xaxis="170" Yaxis="920" gapspace="0" movemode="TL" keyway="top"/>
...
<!-- 하단 -->
<List url="" target="_parent" boxtext="회사소개" boxtexttwo="html_file/site_compnay.html 파일" simages="img/shot/036s.png" bimages="img/shot/036.png" bimgwidth="139" bimgheight="35" Xaxis="20" Yaxis="1523" gapspace="0" movemode="TC" keyway="top"/>

<List url="$sub_url/bbs_regist.php?id=&b_category=&tb=board_bannerreg" target="_parent" boxtext="광고문의" boxtexttwo="게시판관련 부분입니다." simages="img/shot/037s.png" bimages="img/shot/037.png" bimgwidth="120" bimgheight="35" Xaxis="130" Yaxis="1523" gapspace="0" movemode="TC" keyway="top"/>

<List url="" target="_parent" boxtext="개인정보보호정책" boxtexttwo="html_file/site_rule.html 파일" simages="img/shot/038s.png" bimages="img/shot/038.png" bimgwidth="140" bimgheight="35" Xaxis="230" Yaxis="1523" gapspace="0" movemode="TC" keyway="top"/>

<List url="" target="_parent" boxtext="이용약관" boxtexttwo="html_file/site_rule2.html 파일" simages="img/shot/039s.png" bimages="img/shot/039.png" bimgwidth="130" bimgheight="35" Xaxis="340" Yaxis="1523" gapspace="0" movemode="TC" keyway="top"/>

<List url="$sub_url/admin/bbs.php?mode=list" target="_parent" boxtext="공지사항" boxtexttwo="게시판관리로 이동합니다." simages="img/shot/040s.png" bimages="img/shot/040.png" bimgwidth="125" bimgheight="35" Xaxis="445" Yaxis="1523" gapspace="0" movemode="TC" keyway="top"/>

<List url="$sub_url/admin/bbs.php?mode=list" target="_parent" boxtext="커뮤니티" boxtexttwo="관련정보 게시판관리로 이동합니다." simages="img/shot/041s.png" bimages="img/shot/041.png" bimgwidth="125" bimgheight="35" Xaxis="550" Yaxis="1523" gapspace="0" movemode="TC" keyway="top"/>

<List url="$sub_url/admin/bbs.php?mode=list" target="_parent" boxtext="고객지원게시판" boxtexttwo="게시판관리로 이동합니다." simages="img/shot/042s.png" bimages="img/shot/042.png" bimgwidth="171" bimgheight="35" Xaxis="650" Yaxis="1523" gapspace="0" movemode="TC" keyway="top"/>

<List url="$sub_url/admin/main_logo_admin.php" target="_parent" boxtext="하단정보" boxtexttwo="관련정보 로고관리로 이동합니다." simages="img/shot/043s.png" bimages="img/shot/043.png" bimgwidth="950" bimgheight="94" Xaxis="20" Yaxis="1559" gapspace="0" movemode="BL" keyway="top"/>
