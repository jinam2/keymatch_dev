...
<!-- 우측 -->
<List url="$sub_url/admin/underground_maker.php" target="_parent" boxtext="역세권 지하철설정" boxtexttwo="플래시 지하철노선도 설정으로 이동합니다." simages="img/shot/105s.png" bimages="img/shot/105.png" bimgwidth="760" bimgheight="485" Xaxis="170" Yaxis="400" gapspace="0" movemode="TR" keyway="top"/>

<List url="$sub_url/admin/guin.php?a=guin&mode=list" target="_parent" boxtext="채용정보" boxtexttwo="채용정보 관리로 이동합니다." simages="img/shot/106s.png" bimages="img/shot/106.png" bimgwidth="760" bimgheight="135" Xaxis="170" Yaxis="830" gapspace="0" movemode="TR" keyway="top"/>

<List url="$sub_url/admin/guin.php?a=guin&mode=list" target="_parent" boxtext="채용정보리스트" boxtexttwo="채용정보 관리로 이동합니다." simages="img/shot/107s.png" bimages="img/shot/107.png" bimgwidth="760" bimgheight="370" Xaxis="170" Yaxis="970" gapspace="0" movemode="TR" keyway="top"/>
...
-->
<speed keycolor="FF7202" keycolortwo="EEEEEE" bgimg="img/shot/shot09_800.png"/>
</xmlstart>
END;
