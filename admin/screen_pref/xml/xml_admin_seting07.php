...
<!-- 좌측 -->
<List url="" target="_parent" boxtext="마이페이지메뉴" boxtexttwo="temp/default_per.html 파일내용에 포함" simages="img/shot/095s.png" bimages="img/shot/095.png" bimgwidth="180" bimgheight="636" Xaxis="20" Yaxis="200" gapspace="0" movemode="TL" keyway="top"/>
...
<!-- 우측 -->
<List url="$sub_url/admin/admin.php?a=per&mode=list" target="_parent" boxtext="개인회원" boxtexttwo="관련정보 개인회원관리로 이동합니다." simages="img/shot/088s.png" bimages="img/shot/088.png" bimgwidth="760" bimgheight="273" Xaxis="170" Yaxis="235" gapspace="0" movemode="TR" keyway="top"/>

<List url="" target="_parent" boxtext="플래시업로드툴" boxtexttwo="temp/job_per_doc_minialbum.html 템플릿파일" simages="img/shot/089s.png" bimages="img/shot/089.png" bimgwidth="760" bimgheight="163" Xaxis="170" Yaxis="460" gapspace="0" movemode="TR" keyway="top"/>

<List url="$sub_url/admin/happy_config_view.php?number=33" target="_parent" boxtext="기본정보" boxtexttwo="대표관련정보 이력서설정 관리로 이동합니다." simages="img/shot/090s.png" bimages="img/shot/090.png" bimgwidth="760" bimgheight="155" Xaxis="170" Yaxis="590" gapspace="0" movemode="TR" keyway="top"/>

<List url="$sub_url/admin/type_setting.php" target="_parent" boxtext="희망분야" boxtexttwo="관련정보 직종설정으로 이동합니다. " simages="img/shot/091s.png" bimages="img/shot/091.png" bimgwidth="760" bimgheight="86" Xaxis="170" Yaxis="715" gapspace="0" movemode="TR" keyway="top"/>

<List url="$sub_url/admin/area_setting.php" target="_parent" boxtext="업무가능지역" boxtexttwo="대표관련정보 지역설정으로 이동합니다. " simages="img/shot/092s.png" bimages="img/shot/092.png" bimgwidth="760" bimgheight="142" Xaxis="170" Yaxis="785" gapspace="0" movemode="TR" keyway="top"/>

<List url="$sub_url/admin/area_setting.php" target="_parent" boxtext="개인부가정보" boxtexttwo="대표정보 채용/이력서 등록옵션설정으로 이동합니다. " simages="img/shot/093s.png" bimages="img/shot/093.png" bimgwidth="760" bimgheight="291" Xaxis="170" Yaxis="900" gapspace="0" movemode="TR" keyway="top"/>

<List url="$sub_url/admin/money_setup.php?action=member" target="_parent" boxtext="유료옵션" boxtexttwo="개인회원관련 유료화설정으로 이동합니다. " simages="img/shot/094s.png" bimages="img/shot/094.png" bimgwidth="760" bimgheight="540" Xaxis="170" Yaxis="1420" gapspace="0" movemode="TR" keyway="top"/>
...
<!-- 하단 -->
<List url="" target="_parent" boxtext="회사소개" boxtexttwo="html_file/site_compnay.html 파일" simages="img/shot/036s.png" bimages="img/shot/036.png" bimgwidth="139" bimgheight="35" Xaxis="20" Yaxis="2010" gapspace="0" movemode="TC" keyway="top"/>

<List url="$sub_url/bbs_regist.php?id=&b_category=&tb=board_bannerreg" target="_parent" boxtext="광고문의" boxtexttwo="게시판관련 부분입니다." simages="img/shot/037s.png" bimages="img/shot/037.png" bimgwidth="120" bimgheight="35" Xaxis="130" Yaxis="2010" gapspace="0" movemode="TC" keyway="top"/>

<List url="" target="_parent" boxtext="개인정보보호정책" boxtexttwo="html_file/site_rule.html 파일" simages="img/shot/038s.png" bimages="img/shot/038.png" bimgwidth="140" bimgheight="35" Xaxis="230" Yaxis="2010" gapspace="0" movemode="TC" keyway="top"/>

<List url="" target="_parent" boxtext="이용약관" boxtexttwo="html_file/site_rule2.html 파일" simages="img/shot/039s.png" bimages="img/shot/039.png" bimgwidth="130" bimgheight="35" Xaxis="340" Yaxis="2010" gapspace="0" movemode="TC" keyway="top"/>

<List url="$sub_url/admin/bbs.php?mode=list" target="_parent" boxtext="공지사항" boxtexttwo="게시판관리로 이동합니다." simages="img/shot/040s.png" bimages="img/shot/040.png" bimgwidth="125" bimgheight="35" Xaxis="445" Yaxis="2010" gapspace="0" movemode="TC" keyway="top"/>

<List url="$sub_url/admin/bbs.php?mode=list" target="_parent" boxtext="커뮤니티" boxtexttwo="관련정보 게시판관리로 이동합니다." simages="img/shot/041s.png" bimages="img/shot/041.png" bimgwidth="125" bimgheight="35" Xaxis="550" Yaxis="2010" gapspace="0" movemode="TC" keyway="top"/>

<List url="$sub_url/admin/bbs.php?mode=list" target="_parent" boxtext="고객지원게시판" boxtexttwo="게시판관리로 이동합니다." simages="img/shot/042s.png" bimages="img/shot/042.png" bimgwidth="171" bimgheight="35" Xaxis="650" Yaxis="2010" gapspace="0" movemode="TC" keyway="top"/>

<List url="$sub_url/admin/main_logo_admin.php" target="_parent" boxtext="하단정보" boxtexttwo="관련정보 로고관리로 이동합니다." simages="img/shot/043s.png" bimages="img/shot/043.png" bimgwidth="950" bimgheight="94" Xaxis="20" Yaxis="2046" gapspace="0" movemode="BL" keyway="top"/>
