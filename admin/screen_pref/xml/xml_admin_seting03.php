...
<!-- 우측 -->
<List url="$sub_url/admin/type_setting.php" target="_parent" boxtext="인재정보 검색하기" boxtexttwo="대표관련정보 직종(카테고리)설정으로 이동합니다." simages="img/shot/062s.png" bimages="img/shot/062.png" bimgwidth="760" bimgheight="162" Xaxis="170" Yaxis="235" gapspace="0" movemode="TR" keyway="top"/>

<List url="$sub_url/admin/type_setting.php" target="_parent" boxtext="인재정보 카테고리" boxtexttwo="직종(카테고리)설정으로 이동합니다." simages="img/shot/063s.png" bimages="img/shot/063.png" bimgwidth="760" bimgheight="110" Xaxis="170" Yaxis="395" gapspace="0" movemode="TR" keyway="top"/>

<List url="$sub_url/admin/guin.php?a=guzic&mode=list" target="_parent" boxtext="파워링크 인재정보" boxtexttwo="이력서관리로 이동합니다." simages="img/shot/064s.png" bimages="img/shot/064.png" bimgwidth="760" bimgheight="295" Xaxis="170" Yaxis="485" gapspace="0" movemode="TR" keyway="top"/>

<List url="$sub_url/admin/guin.php?a=guzic&mode=list" target="_parent" boxtext="포커스 인재정보" boxtexttwo="이력서관리로 이동합니다." simages="img/shot/065s.png" bimages="img/shot/065.png" bimgwidth="760" bimgheight="279" Xaxis="170" Yaxis="725" gapspace="0" movemode="TR" keyway="top"/>

<List url="$sub_url/admin/guin.php?a=guzic&mode=list" target="_parent" boxtext="스페셜 인재정보" boxtexttwo="이력서관리로 이동합니다." simages="img/shot/066s.png" bimages="img/shot/066.png" bimgwidth="760" bimgheight="270" Xaxis="170" Yaxis="945" gapspace="0" movemode="TR" keyway="top"/>

<List url="$sub_url/admin/guin.php?a=guzic&mode=list" target="_parent" boxtext="인재정보 리스트" boxtexttwo="이력서관리로 이동합니다." simages="img/shot/067s.png" bimages="img/shot/067.png" bimgwidth="760" bimgheight="465" Xaxis="170" Yaxis="1165" gapspace="0" movemode="TR" keyway="top"/>
...
<!-- 하단 -->
<List url="" target="_parent" boxtext="회사소개" boxtexttwo="html_file/site_compnay.html 파일" simages="img/shot/036s.png" bimages="img/shot/036.png" bimgwidth="139" bimgheight="35" Xaxis="20" Yaxis="1597" gapspace="0" movemode="TC" keyway="top"/>

<List url="$sub_url/bbs_regist.php?id=&b_category=&tb=board_bannerreg" target="_parent" boxtext="광고문의" boxtexttwo="게시판관련 부분입니다." simages="img/shot/037s.png" bimages="img/shot/037.png" bimgwidth="120" bimgheight="35" Xaxis="130" Yaxis="1597" gapspace="0" movemode="TC" keyway="top"/>

<List url="" target="_parent" boxtext="개인정보보호정책" boxtexttwo="html_file/site_rule.html 파일" simages="img/shot/038s.png" bimages="img/shot/038.png" bimgwidth="140" bimgheight="35" Xaxis="230" Yaxis="1597" gapspace="0" movemode="TC" keyway="top"/>

<List url="" target="_parent" boxtext="이용약관" boxtexttwo="html_file/site_rule2.html 파일" simages="img/shot/039s.png" bimages="img/shot/039.png" bimgwidth="130" bimgheight="35" Xaxis="340" Yaxis="1597" gapspace="0" movemode="TC" keyway="top"/>

<List url="$sub_url/admin/bbs.php?mode=list" target="_parent" boxtext="공지사항" boxtexttwo="게시판관리로 이동합니다." simages="img/shot/040s.png" bimages="img/shot/040.png" bimgwidth="125" bimgheight="35" Xaxis="445" Yaxis="1597" gapspace="0" movemode="TC" keyway="top"/>

<List url="$sub_url/admin/bbs.php?mode=list" target="_parent" boxtext="커뮤니티" boxtexttwo="관련정보 게시판관리로 이동합니다." simages="img/shot/041s.png" bimages="img/shot/041.png" bimgwidth="125" bimgheight="35" Xaxis="550" Yaxis="1597" gapspace="0" movemode="TC" keyway="top"/>

<List url="$sub_url/admin/bbs.php?mode=list" target="_parent" boxtext="고객지원게시판" boxtexttwo="게시판관리로 이동합니다." simages="img/shot/042s.png" bimages="img/shot/042.png" bimgwidth="171" bimgheight="35" Xaxis="650" Yaxis="1597" gapspace="0" movemode="TC" keyway="top"/>

<List url="$sub_url/admin/main_logo_admin.php" target="_parent" boxtext="하단정보" boxtexttwo="관련정보 로고관리로 이동합니다." simages="img/shot/043s.png" bimages="img/shot/043.png" bimgwidth="950" bimgheight="94" Xaxis="20" Yaxis="1635" gapspace="0" movemode="BL" keyway="top"/>
