...
$admin_now_location="<A HREF='admin.php?a=mem&mode=m_list'>개인회원관리</A> > <A HREF='member_statistics.php'>접속통계요약정보</A>";
...
$sql = "select count(*) from $happy_member where `group` = '1' and reg_date between '$s_date_info' and '$e_date_info'";
//echo $sql;
$result = query($sql);
...
$TPL->define("출력", "$skin_folder/member_statistics_per.html");
$TPL->tprint();
