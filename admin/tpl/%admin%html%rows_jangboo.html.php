<? /* Created by SkyTemplate v1.1.0 on 2023/03/08 00:57:41 */
function SkyTpl_Func_351108518 ($TPL,$DATA,$_index,$_size,$_col) { if ($DATA) $_data=$DATA; else $_data=$GLOBALS;?>
<tr>
	...
	<td class='b_border_td' style='text-align:center;'>
		<a href=jangboo.php?action=jangboo_mod&number=<?=$_data['MONEY']['number']?>&links_number=<?=$_data['MONEY']['links_number']?>&pg=<?=$_data['pg']?> class='btn_small_dark3'>수정</a> <a href="javascript:bbsdel('jangboo.php?action=jangboo_del&number=<?=$_data['MONEY']['number']?>&pg=<?=$_data['pg']?>');" class='btn_small_red2' style='margin-top:3px'>삭제</a>
	</td>
</tr>
