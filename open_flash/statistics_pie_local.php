...
include ("../inc/function.php");
	...
	if($goval_info == "local")
	{
		$Sql = "SELECT LEFT($per_addr1,2) as local from $happy_member WHERE 1=1 $WHERE $group_sql";
		//echo $Sql."<br>";
		$Result = query($Sql);
		while($Data = happy_mysql_fetch_array($Result))
		{
			//$Data[local] = iconv("euc-kr","utf-8", $Data[local]);
			$aData[$Data[local]]++;
		}
	}
...
function open_flash_pie($aData,$s_Text,$view_num = '16'){
