...
var gWeekDay=["<font color=#C00000>일","<font color=black>월","<font color=black>화","<font color=black>수","<font color=black>목","<font color=black>금","<font color=#0000C0>토"];	// weekday caption from Sunday to Saturday
...
var gcCalBG="#CCCCCC";	// the background color of the outer calendar panel.
...
var gsInnerTable="border=0 cellpadding=0 cellspacing=4";	// HTML tag properties of the inner <table> tag, which holds all the calendar cells.
var gsOuterTable=NN4?"border=0 cellpadding=3 cellspacing=0":"border=0 cellpadding=3 cellspacing=3";	// HTML tag properties of the outmost container <table> tag, which holds the top, middle and bottom sections.
...
var gcSat="#0000C0";	// Saturday font color
var gcSatBG="white";	// Saturday background color
var gcSun="#C00000";	// Sunday font color
...
var gcToggle="#FDFF6E";	// the highlight color for the focused cell

var gcFGToday="red";	// the font color for today 
var gcBGToday="silver";	// the background color for today 
...
var gcFGSelected="";	// the font color for the selected date
var gcBGSelected="";	// the background color for the selected date
var guSelectedBGImg="/img/icon_select.gif";	// url of image as background of the selected date
var giMarkSelected=16;	// Effects for selected date - 0: nothing; 1: set background color with gcBGSelected; 2: draw a box with gcBGSelected; 4: bold the font; 8: set font color with gcFGSelected; 16: set background image with guSelectedBGImg; - they can be added up to create mixed effects.
var gsSelectedTip="선택된 날짜입니다";	// tooltip for selected dates
