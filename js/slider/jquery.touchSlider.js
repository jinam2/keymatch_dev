 ...
 * @since	201106
 *
 * @param Object	settings	\xED솚寃쎈\xB3\xEC닔 \xEC삤釉뚯젥\xED듃
 *		roll			-	\xEC닚\xED솚 (default true)
 *		flexible		-	\xEC쑀\xEB룞 \xEB젅\xEC씠\xEC븘\xEC썐 (default false)
 *		view			-	\xEB떎以\x91 而щ읆 (default 1)
 *		speed			-	\xEC븷\xEB땲硫붿씠\xEC뀡 \xEC냽\xEB룄 (default 75)
 *		range			-	\xEB꽆源 \xED뙋\xEC젙 踰붿쐞 (default 0.15)
 *		page			-	珥덇린 \xED럹\xEC씠吏 (default 1)
 *		transition		-	CSS3 transition \xEC궗\xEC슜 (default false)
 ...
 *		initComplete	-	珥덇린\xED솕 肄쒕갚
 *		counter			-	\xEC뒳\xEB씪\xEC씠\xEB뱶 肄쒕갚, 移댁슫\xED꽣
 *
 * @example
