<? /* Created by SkyTemplate v1.1.0 on 2023/03/30 11:48:00 */
function SkyTpl_Func_1486537349 ($TPL,$DATA,$_index,$_size,$_col) { if ($DATA) $_data=$DATA; else $_data=$GLOBALS;?>
...
<div class="sub_wrap">
	<h3 class="sub_tlt_st01">
		<b style="color:#<?=$_data['배경색']['모바일_기본색상']?>">진료과별 </b>
		<span>초빙정보</span>
	</h3>
