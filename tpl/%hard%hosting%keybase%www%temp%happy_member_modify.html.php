<? /* Created by SkyTemplate v1.1.0 on 2023/03/08 00:52:39 */
function SkyTpl_Func_1684097384 ($TPL,$DATA,$_index,$_size,$_col) { if ($DATA) $_data=$DATA; else $_data=$GLOBALS;?>
...
<?call_now_nevi('마이페이지 > <a href="happy_member.php?mode=joinus"> 회원정보수정</a>') ?>
...
<div style="border:1px solid #dfdfdf; margin-bottom:10px; padding:30px;">
	<?happy_member_user_form('회원그룹','전체','happy_member_form_rows.html','happy_member_form_default.html') ?>
