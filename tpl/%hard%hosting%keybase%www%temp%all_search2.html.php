<? /* Created by SkyTemplate v1.1.0 on 2023/04/20 02:06:50 */
function SkyTpl_Func_2402860188 ($TPL,$DATA,$_index,$_size,$_col) { if ($DATA) $_data=$DATA; else $_data=$GLOBALS;?>
			...
			<table cellspacing="0" cellpadding="0">
				<tbody>
					<tr>
						...
						<td>
							<a href="all_search.php?all_keyword=<?=$_data['_GET']['all_keyword']?>&file=all_search2.html" class="search_tab on">
								구인/구직검색
							</a>
						</td>
						<td >
