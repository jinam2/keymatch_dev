<? /* Created by SkyTemplate v1.1.0 on 2023/03/17 08:51:50 */
function SkyTpl_Func_1958689446 ($TPL,$DATA,$_index,$_size,$_col) { if ($DATA) $_data=$DATA; else $_data=$GLOBALS;?>
...
<div class="noto500 font_25" style="position:relative; color:#333333; letter-spacing:-1px; padding-bottom:15px;">
	회원정보 <span class="noto400 font_15" style="color:#777777; letter-spacing:-1px;"><span style="color:#<?=$_data['배경색']['서브색상']?>;"><?=$_data['MEM']['per_name']?></span>님은 <?=$_data['회원그룹명']?>입니다.</span>
	<span style="position:absolute; top:0px; right:0">
		<span class="message">
			<span class="message_bg_01"></span>
			<span class="message_bg_02 font_malgun font_13" style="letter-spacing:-1.5px">쪽지 : <?=$_data['쪽지메세지']?></span>
		</span>
		<?=$_data['추천인링크발급']?>

		<a href="javascript:void(0);" onclick="window.open('happy_member_view.php?view_user_id=<?=$_data['happy_member_login_value']?>','','width=700,height=500');">
			<span class='font_14 noto400' style='background:#fff; color:#666; border:1px solid #ddd; width:110px; height:30px; display:inline-block; border-radius:15px; text-align:center; line-height:30px;'>회원정보보기</span>
		</a>
		<a href="happy_member.php?mode=modify">
			<span class='font_14 noto400' style='background:#fff; color:#666; border:1px solid #ddd; width:110px; height:30px; display:inline-block; border-radius:15px; text-align:center; line-height:30px;'>회원정보수정</span>
		</a>
	</span>
</div>
	...
	<table cellpadding="0" cellspacing="0" style="width:100%; table-layout:fixed">
		<tr>
			<td style="width:865px; vertical-align:top; padding-right:10px; background:url('./img/line_02.gif') right top repeat-y">
				<div style="padding:28px 30px; border:1px solid #d4d4d4">
					<table cellpadding="0" cellspacing="0" style="width:100%">
						<tr>
							<td style="width:200px; text-align:center; padding-right:20px; padding-top:20px">
								<span style="display:block" class="mem_photo">
									<?=$_data['mem_photo']?>

								</span>
								<span style="display:block">
									<a onclick="window.open('./logo_change.php?per_info_id=<?=$_data['MEM']['id']?>','com_log','width=470,height=365,scrollbars=yes')" onmouseover="this.style.cursor='pointer'">
										<img src="img/btn_mypage_myphotomod02.gif" align="absmiddle" border="0" style="margin-top:10px;">
									</a>
								</span>
								<span style="display:block; padding:10px 0" class="font_13 font_malgun">
							...
							<td style="vertical-align:top">
								<h4 style="position:relative; color:#333; letter-spacing:-1px; padding-bottom:6px; margin:0;" class="font_20 noto500">
									...
									<span class="noto400 font_14" style="position:absolute; right:0; top:5px; letter-spacing:-1px; color:#<?=$_data['배경색']['서브색상']?>; cursor:pointer;" onClick="view_layer('view1');" title="보유한 유료옵션보기">
										<img src="img/skin_icon/make_icon/skin_icon_691.jpg" style="vertical-align:middle">
										보유한 유료옵션보기
									</span>
								</h4>
								<div style="position:relative">
									<div id="view1" style="position:absolute; top:0; left:0; display:none" >
										<table cellpadding="0" cellspacing="0" style="width:100%" class="mymain_cominfo">
											...
											<tr>
												...
												<td class="font_14 noto400 sub_1">
													<?=$_data['PERMEMBER']['guzic_smspoint_comma']?> P
													 <a href="member_option_pay3.php">
														<img src="img/sth_more_btn.png" style="vertical-align:middle">
													</a>
												</td>
											</tr>
											<tr>
												<th class="font_14 noto400 title_1">채용열람 유효일</th>
												<td class="font_14 noto400 sub_1">
											...
											<tr>
												<th class="font_14 noto400 title_1">채용열람 가능횟수</th>
												<td class="font_14 noto400 sub_1">
													<?=$_data['PERMEMBER']['guinview_count']?> 회
													 <a href="member_option_pay3.php">
														<img src="img/sth_more_btn.png" style="vertical-align:middle">
													</a>
												</td>
									...
									<table cellpadding="0" cellspacing="0" style="width:100%" class="mymain_cominfo">
										<tr>
											<th class="font_14 noto400 title">생년월일</th>
											...
											<th class="font_14 noto400 title">휴대폰</th>
											<td class="font_14 noto400 sub">
												<span class="ellipsis_line_1" style="display:block; overlfow:hidden; width:161px; line-height:40px; height:40px">
													<?=$_data['MEM']['per_cell']?>
										...
										<tr>
											<th class="font_14 noto400 title">연락처</th>
											<td class="font_14 noto400 sub">
												<span class="ellipsis_line_1" style="display:block; overlfow:hidden; width:161px; line-height:40px; height:40px">
													<?=$_data['MEM']['per_phone']?>
											...
											<th class="font_14 noto400 title">홈페이지</th>
											<td class="font_14 noto400 sub">
												<span class="ellipsis_line_1" style="display:block; overlfow:hidden; width:161px; line-height:40px; height:40px">
													<?=$_data['Data']['user_homepage']?>

												</span>
											</td>
										</tr>
										<tr>
											<th class="font_14 noto400 title" >이메일</th>
											<td class="font_14 noto400 sub" colspan="3">
												<span class="ellipsis_line_1" style="display:block; overlfow:hidden; width:161px; line-height:40px; height:40px">
													<?=$_data['MEM']['per_email']?>
										...
										<tr>
											...
											<td colspan="3"  class="font_14 noto400 sub">
												<span class="ellipsis_line_1" style="display:block; overlfow:hidden; width:400px; line-height:40px; height:40px">
													(<?=$_data['MEM']['per_zip']?>) <?=$_data['MEM']['per_addr1']?> <?=$_data['MEM']['per_addr2']?>
			...
			<td align="right" style="padding-left:10px">
				<?echo happy_banner('일반회원유료옵션','배너제목','랜덤') ?>
	...
	<table cellspacing="0" class="tab" cellpadding="0" style="width:100%; table-layout:fixed; border-collapse: collapse">
		<tr>
			...
			<td class="menu_off" overClass="menu_on" outClass="menu_off" id="class_div_2" onMouseOver="happy_tab_menu('class_div','2');">
				<a href="html_file_per.php?file=member_regph_ing.html" style="display:block; line-height:52px">공개 이력서 ( <?=$_data['PERMEMBER']['use_cnt_comma']?> )</a>
			</td>
			<td class="menu_off" overClass="menu_on" outClass="menu_off" id="class_div_3" onMouseOver="happy_tab_menu('class_div','3');">
				<a href="html_file_per.php?file=member_regph_stop.html" style="display:block; line-height:52px">비공개 이력서 ( <?=$_data['PERMEMBER']['wait_cnt_comma']?> )</a>
			</td>
		</tr>
	</table>
</div>
...
<table cellspacing="0" class="tab2" cellpadding="0" style="width:100%; table-layout:fixed; border-collapse: collapse">
	<tr>
		...
		<td class="menu_off2" overClass="menu_on2" outClass="menu_off2" id="class_div2_2" onMouseOver="happy_tab_menu('class_div2','2');">
			<a href="html_file_per.php?mode=resume_job_application_email" style="display:block; line-height:52px">이메일 입사지원 ( <?=$_data['PERMEMBER']['email_cnt_comma']?> )</a>
		</td>
		<td class="menu_off2" overClass="menu_on2" outClass="menu_off2" id="class_div2_3" onMouseOver="happy_tab_menu('class_div2','3');">
			<a href="per_guin_want.php" style="display:block; line-height:52px">입사제의받은 채용공고 ( <?=$_data['PERMEMBER']['req_cnt_comma']?> )</a>
		</td>
		<td class="menu_off2" overClass="menu_on2" outClass="menu_off2" id="class_div2_4" onMouseOver="happy_tab_menu('class_div2','4');">
			<a href="per_guin_want.php?mode=preview" style="display:block; line-height:52px">면접제의받은 채용공고 ( <?=$_data['PERMEMBER']['interview_cnt_comma']?> )</a>
		</td>
	</tr>
</table>
<div style="padding:20px 0 0 0">
	...
	<table cellpadding="0" cellspacing="0" style="width:100%;background:#f8f8f8">
		<tr>
			<td style="padding-left:20px; letter-spacing:-1.2px; color:#333; height:50px" class="font_18 noto400">
				<a href="per_want_search.php?mode=list" style="color:#333">맞춤채용공고 ( <?=$_data['맞춤채용정보수']?> )</a>
			</td>
			<td style="text-align:right; letter-spacing:-1px; color:#bfbfbf; padding-right:20px" class="font_14 noto400">
				회원님의 등록한 맞춤정보를 바탕으로 사이트에 등록된 채용정공고를 자동으로 검색해주는 서비스입니다.
			</td>
		</tr>
	</table>
	<div>
