...
function SkyTpl_Func_2427450307 ($TPL,$DATA,$_index,$_size,$_col) { if ($DATA) $_data=$DATA; else $_data=$GLOBALS;?>
...
<body>
	...
	<div id="wrap">
		...
		<?include_template('my_view_right_scroll_mypage_per.html') ?>
	...
	<div id='mystickytooltip' class='stickytooltip'><?=$_data['tool_tip_layer']?><div class="stickystatus"></div></div>
	<div id='mystickytooltip_bar' class='stickytooltip_bar'><?=$_data['tool_tip_layer_bar']?><div class="stickystatus"></div></div>
</body>
</html>
