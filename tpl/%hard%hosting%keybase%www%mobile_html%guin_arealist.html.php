<? /* Created by SkyTemplate v1.1.0 on 2023/03/30 11:49:16 */
function SkyTpl_Func_402780713 ($TPL,$DATA,$_index,$_size,$_col) { if ($DATA) $_data=$DATA; else $_data=$GLOBALS;?>
<?
	global $SI;
	if($_GET['search_si'])
	{
...
<div class="sub_wrap">
	<h3 class="sub_tlt_st01">
		<b style="color:#<?=$_data['배경색']['모바일_기본색상']?>">지역별 </b>
		<span>초빙정보</span>
	</h3>
	...
	<div class="sub_guin_list_wrap">
		<h3 class="m_tlt_m_01">
			<strong style="margin-bottom:20px; display:block;"><?=$지역명?> 지역 초빙정보 리스트  <span style="color:#<?=$_data['배경색']['모바일_기본색상']?>;"><span id="guin_counting" >로딩중</span> 건</span></strong>		
