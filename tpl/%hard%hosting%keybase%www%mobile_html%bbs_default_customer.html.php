...
function SkyTpl_Func_1222525657 ($TPL,$DATA,$_index,$_size,$_col) { if ($DATA) $_data=$DATA; else $_data=$GLOBALS;?>
<!doctype html>
<html>
<head>
<!--모바일 전용 meta소스-->
...
<div id="wrap">
	...
	<div id="container">		
		<div class="sub_tab_menu01">
			<?board_keyword_extraction('총50개','가로50개','999자자름','고객지원','sub_rows_board_list_01.html','누락0개') ?>			
		</div>
		<?=$_data['내용']?>
