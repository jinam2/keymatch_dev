<? /* Created by SkyTemplate v1.1.0 on 2023/04/13 16:52:28 */
function SkyTpl_Func_3495460904 ($TPL,$DATA,$_index,$_size,$_col) { if ($DATA) $_data=$DATA; else $_data=$GLOBALS;?>
...
<h3 class="guin_d_tlt_st02">
	 <span style="display:inline-block; vertical-align:middle; width:3px; height:20px; background:#<?=$_data['배경색']['기본색상']?>; margin:0 10px 3px 0;"></span>스크랩한 초빙정보
</h3>
...
<div style="border-top:1px solid #dfdfdf">
	...
	<?guin_extraction('총20개','가로1개','제목길이48자','자동','자동','자동','자동','일반','입사요청','mypage_guin_want_list_row_per1.html') ?>
