<? /* Created by SkyTemplate v1.1.0 on 2023/04/13 16:51:56 */
function SkyTpl_Func_1844496965 ($TPL,$DATA,$_index,$_size,$_col) { if ($DATA) $_data=$DATA; else $_data=$GLOBALS;?>
<div>
	<table cellpadding="0" cellspacing="0" style="width:100%; table-layout:fixed; border-collapse: collapse; background:#f9fcff;">
		<tr>
			<td style="width:107px; text-align:center; border-bottom:1px dashed #dedede">
				<a href="./com_info.php?com_info_id=<?=$_data['GUIN_INFO']['guin_id']?>&guin_number=<?=$_data['GUIN_INFO']['number']?>" target="_blank"><img src="<?=$_data['GUIN_INFO']['logo']?>" alt="기관로고" width="80" height="36" onError="this.src='./img/img_noimage_100x36.jpg'" style="border:1px solid #ccc;"></a>
			</td>
