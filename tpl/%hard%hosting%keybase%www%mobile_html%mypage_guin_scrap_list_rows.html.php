...
function SkyTpl_Func_354455453 ($TPL,$DATA,$_index,$_size,$_col) { if ($DATA) $_data=$DATA; else $_data=$GLOBALS;?>
<div class="hire_listing_04 " style="border-top:1px solid #ddd;">
