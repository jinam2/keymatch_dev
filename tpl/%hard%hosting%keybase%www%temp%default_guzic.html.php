<? /* Created by SkyTemplate v1.1.0 on 2023/03/08 16:14:21 */
function SkyTpl_Func_2447264662 ($TPL,$DATA,$_index,$_size,$_col) { if ($DATA) $_data=$DATA; else $_data=$GLOBALS;?>
...
<body>
	<div id="wrap" style="position:relative;">
		<!-- <img src="../img/guzic_list.jpg" alt="" style="opacity:0.5; position:absolute; top:32px; left:0; right:0; margin:-28px auto; z-index:-1;"/> -->
		...
		<div id="container">
			<div class="locate container_c"><?=$_data['현재위치']?></div>
				<?=$_data['내용']?>
