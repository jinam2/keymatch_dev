...
function SkyTpl_Func_3062139631 ($TPL,$DATA,$_index,$_size,$_col) { if ($DATA) $_data=$DATA; else $_data=$GLOBALS;?>
<div style="width:<?=$_data['B_CONF']['table_size']?>;">
	...
	<div style="border-top:1px solid <?=$_data['B_CONF']['bar_color']?>;">
		...
		<?board_extraction_list('페이지당18개','가로1개','제목길이999자','본문길이0자','현재게시판','bbs_rows_list_text_fixed.html','누락0개') ?>
