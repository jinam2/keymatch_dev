<? /* Created by SkyTemplate v1.1.0 on 2023/03/13 16:02:03 */
function SkyTpl_Func_3585896288 ($TPL,$DATA,$_index,$_size,$_col) { if ($DATA) $_data=$DATA; else $_data=$GLOBALS;?>
...
<div style="width:<?=$_data['B_CONF']['table_size']?>;">
	...
	<div style="border-top:1px solid <?=$_data['B_CONF']['bar_color']?>;" class="bbs_reg_table">
		...
		<tr>
			<th>등록인</th>
			<td class="h_form">
				<input type="text" name="bbs_name" value="<?=$_data['MEMBER']['user_nick']?>" <?=$_data['readonly']?> style="width:200px;"><?=$_data['anonymity_ch']?><!-- #익명게시판 - sun -->
			</td>
		</tr>
