<? /* Created by SkyTemplate v1.1.0 on 2023/04/10 15:42:48 */
function SkyTpl_Func_1713256097 ($TPL,$DATA,$_index,$_size,$_col) { if ($DATA) $_data=$DATA; else $_data=$GLOBALS;?>
...
<input type="hidden" name="top_gonggi" value="<?=$_data['_GET']['top_gonggi']?>">
...
<div style="width:<?=$_data['B_CONF']['table_size']?>;">
	...
	<div style="border-top:1px solid <?=$_data['B_CONF']['bar_color']?>;" class="bbs_reg_table">
		...
		<tr>
			<th class='input_title_st'>처리상태</th>
			<td class='h_form'>
				<label class='h-radio'><input type='radio' id='radio1_01' name='radio1' value ='' <?=$_data['BOARD']['radio0_check']?>><span class='font_15 noto400' style='color:#afafaf;'>접수완료</span></label>
				<label class='h-radio'><input type='radio' id='radio1_02' name='radio1' value ='1' <?=$_data['BOARD']['radio1_check']?>><span class='font_15 noto400' style='color:#afafaf;'>처리완료</span></label>
			</td>
		</tr>
		<tr>
			<th>제목</th>
		...
		<tr>
			<td colspan="2" style="padding:10px 0px;">
				...
				<?echo happy_wys('ckeditor','가로100%','세로450','bbs_review','{BOARD.bbs_review}','./','happycgi_normal','all') ?>
