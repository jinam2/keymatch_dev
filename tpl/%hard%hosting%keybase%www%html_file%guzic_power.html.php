...
function SkyTpl_Func_1530974209 ($TPL,$DATA,$_index,$_size,$_col) { if ($DATA) $_data=$DATA; else $_data=$GLOBALS;?>
<?call_now_nevi('파워링크 인재정보') ?>
...
<div class="container_c">
	<div class="sub_tab_menu01">
		<ul>
			...
			<li style="border-top:4px solid #<?=$_data['배경색']['기본색상']?>; box-sizing:border-box;"><a href="/html_file.php?file=guzic_power.html" style="color:#<?=$_data['배경색']['기본색상']?>; font-weight:500;">파워링크 인재정보</a></li>
		</ul>
	</div>
	<div>
		<h3 class="m_tlt">
		...
		<div style="padding:40px 0 40px 0;" class="sub_power_list2">
			<?newPaging_option('번호양쪽9개노출','구간이동버튼','이전다음버튼','<<','이전','다음','>>') ?>

			<?document_extraction_list('가로1개','세로10개','옵션1','옵션2','스페셜','옵션4','최근등록일순','글자999글자짜름','누락0개','sub_guzic_power_list_rows.html','페이징사용') ?>
