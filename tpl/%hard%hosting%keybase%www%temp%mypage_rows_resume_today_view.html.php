<? /* Created by SkyTemplate v1.1.0 on 2023/03/28 14:09:31 */
function SkyTpl_Func_465579688 ($TPL,$DATA,$_index,$_size,$_col) { if ($DATA) $_data=$DATA; else $_data=$GLOBALS;?>
<div>
	<table cellpadding="0" cellspacing="0" style="width:100%; table-layout:fixed; border-collapse: collapse;">
		<tr>
			...
			<td style="border:1px solid #dfdfdf; border-right:0 none; border-top:0 none; padding:25px 0 25px 30px; vertical-align:top; text-align:left;">
				<h4 class="font_18 noto400 ellipsis_line_1" style="width:500px; letter-spacing:-1px; margin:0;">
