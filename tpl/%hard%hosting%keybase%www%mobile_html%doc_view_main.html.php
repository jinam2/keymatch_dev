<? /* Created by SkyTemplate v1.1.0 on 2023/03/28 17:41:12 */
function SkyTpl_Func_1844911265 ($TPL,$DATA,$_index,$_size,$_col) { if ($DATA) $_data=$DATA; else $_data=$GLOBALS;?>
<!-- 카카오스토리 링크 -->
...
<div class="sub_wrap">
			...
			<li>
				<div>
					...
					<p>
						...
						<span style="width:20px;"><?=$_data['naverBand']?></span>
					</p>
				</div>
			</li>
			<li>
			...
			<li>
				<div class="guzic_d_top_info_basic">
					<ul class="info_txt_box">
						<li>
							<strong style="color:#<?=$_data['배경색']['모바일_기본색상']?>">휴대폰</strong>
							<p><?=$_data['Data']['user_hphone']?></p>
						</li>
						<li>
							<strong>전화번호</strong>
	...
	<div class="guzic_d_content_wrap">		
		...
		<ul id="class2" style="display:none;">
			<li>
				<h5 class="front_bar_st_tlt">OA 능력</h5>
				<div class="guzic_d_con_skill">
					<ul>
						<li>
							<b>워드(한글/MS워드)</b>
							<p>
								<img src="mobile_img/graph<?=$_data['Data']['skill_word']?>.png" alt="<?=$_data['Data']['skill_word_han']?>">
								<span><?=$_data['Data']['skill_word_han']?></span>
							</p>
						</li>
						<li>
							<b>프리젠테이션(파워포인트)</b>
							<p>
								<img src="mobile_img/graph<?=$_data['Data']['skill_ppt']?>.png" alt="<?=$_data['Data']['skill_ppt_han']?>">
								<span><?=$_data['Data']['skill_ppt_han']?></span>
							</p>
						</li>
						<li>
							<b>스프레드시트(엑셀)</b>
							<p>
								<img src="mobile_img/graph<?=$_data['Data']['skill_excel']?>.png" alt="<?=$_data['Data']['skill_excel_han']?>">
								<span><?=$_data['Data']['skill_excel_han']?></span>
							</p>
						</li>
						<li>
							<b>인터넷(정보검색/Outlook)</b>
							<p>
								<img src="mobile_img/graph<?=$_data['Data']['skill_search']?>.png" alt="<?=$_data['Data']['skill_search_han']?>">
								<span><?=$_data['Data']['skill_search_han']?></span>
							</p>
						</li>
					</ul>
				</div>				
