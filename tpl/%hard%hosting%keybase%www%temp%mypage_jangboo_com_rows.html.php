...
function SkyTpl_Func_1574146480 ($TPL,$DATA,$_index,$_size,$_col) { if ($DATA) $_data=$DATA; else $_data=$GLOBALS;?>
<table cellspacing="0" style="width:100%; height:60px; border-collapse: collapse;">
	<tr>
		...
		<td class="font_14 noto400" align="left" style="padding:20px 0 20px 30px; border:1px solid #dfdfdf; border-top:0 none; line-height:24px">
			<?=$_data['Jangboo']['goods_name']?>
