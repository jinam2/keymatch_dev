<? /* Created by SkyTemplate v1.1.0 on 2023/03/27 20:43:51 */
function SkyTpl_Func_440566926 ($TPL,$DATA,$_index,$_size,$_col) { if ($DATA) $_data=$DATA; else $_data=$GLOBALS;?>
<?call_now_nevi('프리미엄 채용정보') ?>
...
<div class="container_c">
	<div class="sub_tab_menu01">
		<ul>
			...
			<li style="border-top:4px solid #<?=$_data['배경색']['기본색상']?>; box-sizing:border-box;"><a href="/html_file.php?file=guin_premium.html" style="color:#<?=$_data['배경색']['기본색상']?>; font-weight:500;">프리미엄 초빙정보</a></li>
			<li><a href="/html_file.php?file=guin_special.html">스페셜 초빙정보</a></li>
		</ul>
	</div>
	<div>
		<h3 class="m_tlt">
			<strong>프리미엄 초빙정보 리스트</strong>
		...
		<div style="padding:40px 0 40px 0" class="sub_premium_list2">
			...
			<?guin_extraction('총8개','가로4개','제목길이200자','자동','자동','자동','자동','프리미엄','자동','sub_guin_premium_list_rows.html','누락0개','사용함','','최근등록일순') ?>
