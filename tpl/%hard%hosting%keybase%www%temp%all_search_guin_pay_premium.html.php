...
function SkyTpl_Func_3596181958 ($TPL,$DATA,$_index,$_size,$_col) { if ($DATA) $_data=$DATA; else $_data=$GLOBALS;?>
...
<div style="width:956px; margin-left:-8px;"><?=$_data['검색결과리스트']?></div>
<div style="text-align:right; padding:0 0 10px 0">
	<a href="html_file.php?action=search&file=guin_premium.html&file2=&title_read=<?=$_data['검색어']?>" style="color:#0000cc; font-size:15px;">
