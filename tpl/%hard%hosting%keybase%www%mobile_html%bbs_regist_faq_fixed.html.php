<? /* Created by SkyTemplate v1.1.0 on 2023/03/30 13:27:29 */
function SkyTpl_Func_2174266124 ($TPL,$DATA,$_index,$_size,$_col) { if ($DATA) $_data=$DATA; else $_data=$GLOBALS;?>
...
<div class="h_form">
	<div class="bbs_reg_form">
		...
		<div class="bbs_reg_form_list">
			<span class="bbs_reg_form_title">질문명</span>
