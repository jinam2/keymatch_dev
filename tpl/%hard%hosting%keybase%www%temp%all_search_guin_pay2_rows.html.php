...
function SkyTpl_Func_1959836823 ($TPL,$DATA,$_index,$_size,$_col) { if ($DATA) $_data=$DATA; else $_data=$GLOBALS;?>
<div class="hire_listing_01">
	<a href="com_info.php?com_info_id=<?=$_data['Data']['guin_id']?>&guin_number=<?=$_data['Data']['number']?>">
		<img src="<?=$_data['Data']['logo']?>"  border="0" align="absmiddle" width="<?=$_data['ComBannerDstW']?>" height="<?=$_data['ComBannerDstH']?>" style=";">
		<b><?=$_data['Data']['name']?></b>
