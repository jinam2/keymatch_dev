<? /* Created by SkyTemplate v1.1.0 on 2023/03/31 08:31:45 */
function SkyTpl_Func_3832104753 ($TPL,$DATA,$_index,$_size,$_col) { if ($DATA) $_data=$DATA; else $_data=$GLOBALS;?>
<?call_now_nevi('<a href=happy_member.php?mode=mypage>마이페이지</a> > 비공개 이력서') ?>
...
<h3 class="guin_d_tlt_st02">
	 <span style="display:inline-block; vertical-align:middle; width:3px; height:20px; background:#<?=$_data['배경색']['기본색상']?>; margin:0 10px 3px 0;"></span>비공개 이력서
</h3>
...
<div>
	<div style="border-top:1px solid #ccc">
		...
		<?document_extraction_list('가로1개','세로5개','옵션1','옵션2','옵션3','내가등록한비공개중인이력서','최근등록일순','50글자짜름','누락0개','mypage_doc_rows.html','페이징사용') ?>
