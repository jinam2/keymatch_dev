...
function SkyTpl_Func_949203799 ($TPL,$DATA,$_index,$_size,$_col) { if ($DATA) $_data=$DATA; else $_data=$GLOBALS;?>
...
<div class="noto500 font_25" style="position:relative; color:#333333; letter-spacing:-1px; padding-bottom:15px;">
	기관정보 <span class="noto400 font_15" style="color:#777777; letter-spacing:-1px;"><span style="color:#<?=$_data['배경색']['서브색상']?>;"><?=$_data['MEM']['boss_name']?></span>님은 <?=$_data['회원그룹명']?>입니다.</span>
	<span style="position:absolute; top:0px; right:0">
		<span class="message">
			<span class="message_bg_01"></span>
			<span class="message_bg_02 noto400 font_14" style="color:#666666; letter-spacing:-1px">쪽지 : <?=$_data['쪽지메세지']?></span>
		</span>
		<?=$_data['추천인링크발급']?>
...
<!-- 		<a href="javascript:void(0);" onclick="window.open('happy_member_view.php?view_user_id=<?=$_data['happy_member_login_value']?>','','width=700,height=500');">
			<span class='font_14 noto400' style='background:#fff; color:#666; border:1px solid #ddd; width:110px; height:30px; display:inline-block; border-radius:15px; text-align:center; line-height:30px;'>기업정보보기</span>
		</a> -->
		<a href="happy_member.php?mode=modify">
			<span class='font_14 noto400' style='background:#<?=$_data['배경색']['기본색상']?>; color:#fff; border:1px solid #<?=$_data['배경색']['기본색상']?>; width:110px; height:30px; display:inline-block; border-radius:15px; text-align:center; line-height:30px;'>기관정보수정</span>
		</a>
	</span>
</div>
