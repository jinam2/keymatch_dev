...
function SkyTpl_Func_4119984886 ($TPL,$DATA,$_index,$_size,$_col) { if ($DATA) $_data=$DATA; else $_data=$GLOBALS;?>
...
<div style="width:990px; margin-left:-20px;"><?=$_data['검색결과리스트']?></div>
<div style="text-align:right; padding:10px 0">
	<a href="html_file.php?file=guzic_special.html&guzic_keyword=<?=$_data['검색어']?>" style="color:#0000cc; font-size:15px;">
