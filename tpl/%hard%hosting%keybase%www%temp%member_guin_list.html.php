...
function SkyTpl_Func_897883293 ($TPL,$DATA,$_index,$_size,$_col) { if ($DATA) $_data=$DATA; else $_data=$GLOBALS;?>
<div>
	...
	<tr>
		<td style="width:180px; background:#f5f7fb; text-align:center; border:1px solid #dfdfdf; border-left:0 none; border-top:0 none !important">
			...
			<span class="font_13 noto400" style="display:block; color:#fff; margin:0 auto; width:80px; height:20px; border-radius:10px; background:#<?=$_data['배경색']['기본색상']?>; text-align:center;">
		...
		<td style="border:1px solid #dfdfdf; padding:25px 30px; vertical-align:top; text-align:left; border-top:0 none !important">
			<h4 class="font_18 noto400" style="letter-spacing:-1px; padding-bottom:15px; margin:0;">
			...
			<tr>
				<th class="font_15 noto400">담당업무</th>
				<td class="font_15 noto400"><?=$_data['GUIN_INFO']['guin_work_content']?></td>
			</tr>
			<tr>
				<th class="font_15 noto400">직종</th>
				<td class="font_15 noto400"><?=$_data['GUIN_INFO']['guin_job_1']?></td>
			</tr>
			<tr>
				<th class="font_15 noto400">급여</th>
				<td class="font_15 noto400"><?=$_data['GUIN_INFO']['guin_pay']?></td>
			</tr>
			<tr>
				<th class="font_15 noto400">학력</th>
				<td class="font_15 noto400"><?=$_data['GUIN_INFO']['guin_edu']?></td>
			</tr>
			<tr>
				<th class="font_15 noto400">경력</th>
				<td class="font_15 noto400"><?=$_data['GUIN_INFO']['guin_career']?></td>
			</tr>
			</table>
		</td>
		<td style="width:220px; border:1px solid #dfdfdf; background:#fcfcfc; border-top:0 none !important">
			<div style="padding:40px 30px; line-height:24px">
				...
				미열람 <strong style="color:#<?=$_data['배경색']['서브색상']?>"><?=$_data['GUIN_STATS']['total_mi']?></strong> 명
				</a>
				</span>
				<span style="display:block; letter-spacing:-1px" class="font_15 noto400">
				<a href="guzic_list.php?file=member_guin_ok&number=<?=$_data['GUIN_INFO']['number']?>&myroom=&doc_ok=Y">
				예비합격 <strong style="color:#333"><?=$_data['GUIN_STATS']['total_pre_pass']?></strong> 명
				</a>
				</span>
				<span style="display:block; letter-spacing:-1px" class="font_15 noto400">
				<a href="guzic_list.php?file=member_guin_scrap&number=<?=$_data['GUIN_INFO']['number']?>">
				스크랩 <strong style="color:#333"><?=$_data['GUIN_STATS']['total_scrap']?></strong> 명
				</a>
				</span>
			</div>
		</td>
