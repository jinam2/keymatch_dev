<? /* Created by SkyTemplate v1.1.0 on 2023/04/17 18:47:12 */
function SkyTpl_Func_268320895 ($TPL,$DATA,$_index,$_size,$_col) { if ($DATA) $_data=$DATA; else $_data=$GLOBALS;?>
<?call_now_nevi('마이페이지 > 이력서 열람관리') ?>
...
<h3 class="guin_d_tlt_st02" style="position:relative;">
	 <span style="display:inline-block; vertical-align:middle; width:3px; height:20px; background:#<?=$_data['배경색']['기본색상']?>; margin:0 10px 3px 0;"></span>이력서 열람관리
</h3>
<div style="border-top:1px solid #ddd;">
	<?newPaging_option('번호양쪽9개노출','구간이동버튼','이전다음버튼','<<','이전','다음','>>') ?>

	<?document_extraction_list('가로1개','세로15개','옵션1','옵션2','상세보기이력서','옵션4','최근등록일순','글자22글자짜름','누락0개','mypage_doc_rows_default.html','페이징사용') ?>

</div>
<div align="center" class="paging_mypage" style="margin-top:50px;"><?=$_data['페이징']?></div>
<? }
?>