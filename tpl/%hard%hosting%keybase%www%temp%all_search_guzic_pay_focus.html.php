...
function SkyTpl_Func_4016308678 ($TPL,$DATA,$_index,$_size,$_col) { if ($DATA) $_data=$DATA; else $_data=$GLOBALS;?>
...
<div style="text-align:right; padding:10px 0">
	<a href="html_file.php?file=guzic_focus.html&guzic_keyword=<?=$_data['검색어']?>" style="color:#0000cc; font-size:15px;">
