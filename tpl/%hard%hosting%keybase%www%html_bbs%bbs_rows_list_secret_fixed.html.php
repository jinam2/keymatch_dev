...
function SkyTpl_Func_1797968256 ($TPL,$DATA,$_index,$_size,$_col) { if ($DATA) $_data=$DATA; else $_data=$GLOBALS;?>
...
<tr>
	<td style="width:80px; text-align:center;" class="noto400 font_15 bbs_rows_num h_form">
