<? /* Created by SkyTemplate v1.1.0 on 2023/03/29 16:47:59 */
function SkyTpl_Func_2602652128 ($TPL,$DATA,$_index,$_size,$_col) { if ($DATA) $_data=$DATA; else $_data=$GLOBALS;?>
<style type="text/css">
...
<div class="sub_wrap">
	<h3 class="sub_tlt_st01">
		<b style="color:#<?=$_data['배경색']['모바일_기본색상']?>"><?=$_data['카테고리명']['1차']?> </b>
		<span>초빙정보</span>
	</h3>
	...
	<div class="sub_guin_list_wrap">
		<h3 class="m_tlt_m_01">
			<strong style="margin-bottom:20px; display:block;"><?=$_data['카테고리명']['1차']?> 초빙 리스트  <span style="color:#<?=$_data['배경색']['모바일_기본색상']?>;"><span id="guin_counting" >로딩중</span> 건</span></strong>		
