...
function SkyTpl_Func_3955744614 ($TPL,$DATA,$_index,$_size,$_col) { if ($DATA) $_data=$DATA; else $_data=$GLOBALS;?>
<?
global $BOARD,$GU,$SI;
...
// 지역부터 작업해야함.
?>
<div class="alba_listing_01" style="">
	<?=$_data['BOARD']['bbs_link1']?>

		<span>
			<img src="<?echo happy_image('BOARD.thumb','가로48','세로48','로고사용안함','로고위치7번','퀄리티100','gif원본출력','img/no_photo.gif','비율대로확대','2') ?>">
		</span>
		<p>
			<b><?=$_data['BOARD']['phone']?>(<?=$_data['BOARD']['radio2']?>ㆍ<?=$_data['BOARD']['radio3']?>)</b>	
