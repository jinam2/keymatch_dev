...
function SkyTpl_Func_1405045842 ($TPL,$DATA,$_index,$_size,$_col) { if ($DATA) $_data=$DATA; else $_data=$GLOBALS;?>
...
<?include_template('happy_multi_upload_image_rows.html') ?>
...
var data_key_number			= '<?=$_data['_GET']['number']?>';
