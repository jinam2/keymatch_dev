<? /* Created by SkyTemplate v1.1.0 on 2023/03/28 08:47:31 */
function SkyTpl_Func_2315264986 ($TPL,$DATA,$_index,$_size,$_col) { if ($DATA) $_data=$DATA; else $_data=$GLOBALS;?>
<div class="hire_listing_04 " style="height:auto; border-bottom:1px solid #ddd; padding:15px 0; box-sizing:border-box;">
