<? /* Created by SkyTemplate v1.1.0 on 2023/03/28 16:14:36 */
function SkyTpl_Func_2302045590 ($TPL,$DATA,$_index,$_size,$_col) { if ($DATA) $_data=$DATA; else $_data=$GLOBALS;?>
...
<div style="width:<?=$_data['B_CONF']['table_size']?>;">
	...
	<div style="border-top:1px solid <?=$_data['B_CONF']['bar_color']?>;" class="bbs_reg_table">
		...
		<tr>
			<th>첨부파일1</th>
			<td class="h_form">
				<input type="file" name="img[]" class="input_text_st" style="width:80%;"> <span class="check_box_st bbs_font_st"><?=$_data['BOARD']['etc1_del']?></span>
			</td>
		</tr>
		<tr>
			<th>첨부파일2</th>
			<td class="h_form">
				<input type="file" name="img[]" class="input_text_st" style="width:80%;"> <span class="check_box_st bbs_font_st"><?=$_data['BOARD']['attach2_del']?></span>
			</td>
		</tr>
		<tr>
			<th>첨부파일3</th>
			<td class="h_form">
				<input type="file" name="img[]" class="input_text_st" style="width:80%;"> <span class="check_box_st bbs_font_st"><?=$_data['BOARD']['attach3_del']?></span>
			</td>
		</tr>
		</table>
	</div>
