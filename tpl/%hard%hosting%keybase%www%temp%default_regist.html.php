...
function SkyTpl_Func_1594831541 ($TPL,$DATA,$_index,$_size,$_col) { if ($DATA) $_data=$DATA; else $_data=$GLOBALS;?>
...
<body>
	<div id="wrap" style="position:relative;">
		<!-- <img src="../img/guzic_detail.jpg" alt="" style="opacity:0.5; position:absolute; top:32px; left:0; right:0; margin:-28px auto; z-index:-1;"/> -->
