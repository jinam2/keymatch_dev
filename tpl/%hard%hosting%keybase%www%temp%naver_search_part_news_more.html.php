<? /* Created by SkyTemplate v1.1.0 on 2023/04/20 17:35:41 */
function SkyTpl_Func_4020649496 ($TPL,$DATA,$_index,$_size,$_col) { if ($DATA) $_data=$DATA; else $_data=$GLOBALS;?>
...
<div style="width:940px; float:left; padding-top:30px">
	<?echo naver_search_api('세로20개','가로1개','naver_search_part2.html','naver_search_news_rows.html','자동','페이징사용') ?>
