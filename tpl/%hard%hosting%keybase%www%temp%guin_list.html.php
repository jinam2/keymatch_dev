<? /* Created by SkyTemplate v1.1.0 on 2023/04/18 13:12:06 */
function SkyTpl_Func_4007211403 ($TPL,$DATA,$_index,$_size,$_col) { if ($DATA) $_data=$DATA; else $_data=$GLOBALS;?>
<!-- 페이지내 rows디자인 색생 변경을 위한 css입니다 -->
<h3 class="sub_tlt_st01">
	<span style="color:#<?=$_data['배경색']['기본색상']?>">유형별</span>
	<b>초빙정보</b>	
</h3>
...
<div class="behind_bg">
	<ul class="guin_optionlist_wrap container_c">
		<li>
			...
			<div class="m_list_01"><?guin_main_extraction('총12개','가로4개','제목길이100자','자동','자동','자동','자동','우대등록','전체','sub_rows_guin_woodae_01.html','최신등록순','누락0개','','','','자동') ?></div>
		</li>
		<li>		
			<h3 class="m_tlt">
