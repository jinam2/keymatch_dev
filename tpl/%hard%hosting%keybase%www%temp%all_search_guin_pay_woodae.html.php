...
function SkyTpl_Func_2266548787 ($TPL,$DATA,$_index,$_size,$_col) { if ($DATA) $_data=$DATA; else $_data=$GLOBALS;?>
...
<div style="text-align:right; padding:10px 0">
	<a href="html_file.php?action=search&file=guin_woodae.html&file2=&title_read=<?=$_data['검색어']?>" style="color:#0000cc; font-size:15px;">
