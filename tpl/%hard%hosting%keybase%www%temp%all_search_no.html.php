<? /* Created by SkyTemplate v1.1.0 on 2023/04/20 02:04:08 */
function SkyTpl_Func_1220299280 ($TPL,$DATA,$_index,$_size,$_col) { if ($DATA) $_data=$DATA; else $_data=$GLOBALS;?>
		...
		<div style="position:relative; background:url('./img/all_sch_bgline.gif') 0 0 repeat-x" >
			...
			<tr>
				...
				<td >
					...
					<img src="img/all_search_tab_04_off.jpg" alt="네이버검색">
					</a>
				</td>
			</tr>
			</table>
...
<div style="width:940px; float:left; padding-top:30px">
	...
	<tr>
		<td align='center' class="noto400 font_15" height=300>검색 결과가 존재하지 않습니다.</td>
	</tr>
	</table>
</div>
