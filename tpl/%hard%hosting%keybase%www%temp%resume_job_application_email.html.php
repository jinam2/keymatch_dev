<? /* Created by SkyTemplate v1.1.0 on 2023/03/23 11:26:58 */
function SkyTpl_Func_275061258 ($TPL,$DATA,$_index,$_size,$_col) { if ($DATA) $_data=$DATA; else $_data=$GLOBALS;?>
<?call_now_nevi('마이페이지 > 이메일 입사지원') ?>
...
<h3 class="guin_d_tlt_st02">
	 <span style="display:inline-block; vertical-align:middle; width:3px; height:20px; background:#<?=$_data['배경색']['기본색상']?>; margin:0 10px 3px 0;"></span>최근 열람한 초빙정보
</h3>
...
<form name="guin_per_search" action="" method="get">
	...
	<input type="hidden" name="mode" value="<?=$_data['_GET']['mode']?>">
...
<div style="border-top:1px solid #dfdfdf">
	...
	<?document_extraction_list('가로1개','세로15개','옵션1','옵션2','내가신청한구인(이메일)','옵션4','최근등록일순','글자60글자짜름','누락0개','mypage_output_regadd_guin.html','페이징사용') ?>
