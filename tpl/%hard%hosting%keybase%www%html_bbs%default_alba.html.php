...
function SkyTpl_Func_4142658347 ($TPL,$DATA,$_index,$_size,$_col) { if ($DATA) $_data=$DATA; else $_data=$GLOBALS;?>
...
<link rel="stylesheet" type="text/css" href="css/scrollbar/scrollbar_skin_edit.css">
<script language="javascript" type="text/javascript" src="js/scrollbar/jquery_scrollbar.js"></script>
<!-- 게시판 상세에서 사용하는 커스텀 스크롤바-->
