...
class XML {
    ...
    //load_file -> load_xml濡\x9C \xED뙆\xEC씪 諛\x8F string \xEC쑝濡\x9C 紐⑤몢 \xEC엯\xEB젰諛쏆쓣 \xEC닔 \xEC엳\xEC쓬.
    function XML($file = "") {
    ...
    //modify by ddaemiri, 2007.05.28
    //charset 異붽\xB0( header \xEC깮\xEC꽦 )
     ...
     */
    //modify by ddaemiri, 2007.05.28
    //get_file -> get_xml 濡\x9C \xED븿\xEC닔\xEC씠由\x84 蹂寃\xBD. 
    ...
    function handle_character_data($parser, $text) {
        ...
        // add array, added by ddaemiri, 2007.09.03
        $arr = preg_split("/[\/]+/", $this->path, -1, PREG_SPLIT_NO_EMPTY);
        //edited by ddaemiri. libexpat\xEC\x9D \n\xEC쓣 遺꾨━\xEC옄濡\x9C \xEC씤\xEC떇
    ...
    //entity 媛 \xED븯\xEB굹留\x8C \xEC엳\xEB떎怨\xA0 媛\xEC젙!! 諛곗뿴\xEC쓽 泥ル쾲吏몃쭔 媛\xEC졇\xEC샂.
